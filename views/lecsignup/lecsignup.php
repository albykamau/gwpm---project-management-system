...
<head
<?php
  include_once "lecsignup_php.php";
  ?>
    <meta charset="utf-8">
        ...
        <div class="container h-100">
            <div class="row justify-content-md-center h-100">
                <div class="card-wrapper">
                    ...
                    <div class="card fat">
                        <div class="card-body">
                            <h4 class="card-title">Create your Lecturer's account</h4>
                            <div class="mt-4 text-center">
                                    Are you a student? <a href="../signup/signup.php">Create student Account</a>
                                </div>
                            <!-- signup validation-->
                            <form method="POST" class="my-login-validation" novalidate="" action="lecsignup_php.php">
                                ...
                                <div class="mt-4 text-center">
                                    Already have an account? <a href="../leclogin/leclogin.php">Login</a>
                                </div>
