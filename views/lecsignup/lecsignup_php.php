    ...
    if(empty($_POST['password'])){
        ...
        if(empty($data_missing)){
            ...
            require_once('../config.php');
             ...
             // prepare and bind
             $stmt = $mysqli -> prepare("INSERT INTO lecturers (fname, username, email, passsword) VALUES (?,?,?,?)");
           ...
           // mysqli_stmt_bind_param($stmt,"ssss", $f_name,$uname,$email,$password);
            ...
            if($affected_rows == 1){
                echo '<script>alert("Success. You can now log in as a Lecturer")</script>';
                header('refresh:2;url= ../leclogin/leclogin.php');
