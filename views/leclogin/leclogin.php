...
<head>
  ...
  ?>
    ...
    <title>Lecturer's Login Page</title>
        ...
        <div class="container h-100">
            <div class="row justify-content-md-center h-100">
                <div class="card-wrapper">
                    ...
                    <div class="card fat">
                        <div class="card-body">
                            <h4 class="card-title">Login to your Lecturer's account</h4>
                            <div class="mt-4 text-center">
                                    Are you a student? <a href="../login/login.php">Login as a Student</a>
                                </div>
                            <!---FORM ACTION-->
                            <form method="POST" class="my-login-validation" novalidate="" action="leclogin_php.php">
                                ...
                                <div class="form-group m-0">
                                    <button type="submit" name="logeen" style="background-color: #0a192f; color: white; border-color: cyan; border-radius: 20px;" class="btn btn-block">
										Login
									</button>
                                </div>
                                <div class="mt-4 text-center">
                                    Don't have an account? <a href="../lecsignup/lecsignup.php">Create One</a>
                                </div>
